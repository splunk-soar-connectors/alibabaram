...
This table lists the configuration variables required to operate Alibaba RAM. These variables are specified when configuring a Alibaba Resource Access Management asset in Splunk SOAR.
